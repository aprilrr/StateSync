...
#[derive(Debug)]
pub struct StateSyncProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StateSyncProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StateSync processing");
    
    let mut processor = StateSyncProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StateSyncProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StateSyncProcessor::new(false);
